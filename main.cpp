...
/*Assignment 1:
Modify your merge program to work with vector

Assignment 2:
Modify the Encryption Assignment to use string.
Declare filenames, key and encoded message as strings.

Rewrite the program as an Encryption class. Include appropriate member functions.
Create a member function that will decrypt the message as well.


Assignment 3:
From p56 in C++ for You++ workbook,

Write a member function of string to solve arithmetic.
Strings in the form "int1 op int2" will return the result of arithmetic operation

E.g.   apstring math = "3 + 4"

cout << math.arithmetic() << endl;			// prints 7

Remember to use find and substr functions.
*/
